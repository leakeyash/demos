...
namespace Repository.Implementations
{
    public class Repository<T> : IRepository<T> where T : IEntity
    {
        ...
        {
            return Retry(() => { return Task.Run(() => { return Delete(id); }); });
        }
        ...
        {
            return Retry(() => { return Collection.DeleteMany(filter).IsAcknowledged; });
        }
        ...
        {
            return Retry(() => { return Task.Run(() => { return Delete(filter); }); });
        }
        ...
        {
            return Retry(() => { return Collection.DeleteMany(Filter.Empty).IsAcknowledged; });
        }
        ...
        {
            return Retry(() => { return Task.Run(() => { return DeleteAll(); }); });
        }
        ...
        {
            return Retry(() => { return Query().ToEnumerable(); });
        }
        ...
        {
            return Retry(() => { return Collection.InsertOneAsync(entity); });
        }
        ...
        {
            return Retry(() => { return Collection.InsertManyAsync(entities); });
        }
        ...
        {
            return Retry(() => { return Collection.ReplaceOne(i => i.Id == entity.Id, entity).IsAcknowledged; });
        }
        ...
        {
            return Retry(() => { return Task.Run(() => { return Replace(entity); }); });
        }
        ...
        {
            return Task.Run(() => { return Update(entity, Updater.Set(field, value)); });
        }
        ...
        {
            return Task.Run(() => { return Update(Filter.Eq(i => i.Id, id), updates); });
        }
        ...
        {
            return Task.Run(() => { return Update(entity.Id, updates); });
        }
        ...
        /// <param name="field">field</param>
        /// <param name="value">new value</param>
        public Task<bool> UpdateAsync<TField>(FilterDefinition<T> filter, Expression<Func<T, TField>> field,
            TField value)
        {
            return Task.Run(() => { return Update(filter, Updater.Set(field, value)); });
        }
        ...
        {
            return Retry(() => { return Task.Run(() => { return Update(filter, updates); }); });
        }
        ...
        {
            return Retry(() => { return First(filter) != null; });
        }
        ...
        {
            return Retry(() => { return Collection.Count(filter); });
        }
        ...
        {
            return Retry(() => { return Collection.CountAsync(filter); });
        }
        ...
        public long Count()
        {
            return Retry(() => { return Collection.Count(Filter.Empty); });
        }
        ...
        {
            return Retry(() => { return Collection.CountAsync(Filter.Empty); });
        }
